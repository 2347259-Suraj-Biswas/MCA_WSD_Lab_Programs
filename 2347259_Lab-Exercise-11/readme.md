You are a junior developer working on a basic task management application using React. The application should allow users to add tasks, view a list of tasks, edit task details, and delete tasks.
